...
return [
    ...
    'question_sources_by_role' => [
        'Server Specialist' => dirname(__DIR__) . '/server-beverage-cook.txt',
        'Beverage Specialist' => dirname(__DIR__) . '/server-beverage-cook.txt',
        'Senior Cook' => dirname(__DIR__) . '/server-beverage-cook.txt',
        'Manager' => dirname(__DIR__) . '/manager-asisten_manager-admin_operasional.txt',
        'Asisten Manager' => dirname(__DIR__) . '/manager-asisten_manager-admin_operasional.txt',
        'Admin Operasional' => dirname(__DIR__) . '/manager-asisten_manager-admin_operasional.txt',
    ],
